...
import 'package:network_video_trimmer/src/trim_viewer/trim_editor_painter.dart';
import 'package:network_video_trimmer/src/trim_viewer/trim_area_properties.dart';
import 'package:network_video_trimmer/src/trim_viewer/trim_editor_properties.dart';
import 'package:network_video_trimmer/src/trimmer.dart';
import 'package:network_video_trimmer/src/utils/duration_style.dart';
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      ...
      setState(() {
        ...
        final numberOfThumbnailsTotal = (numberOfThumbnailsInArea *
                (totalDuration.inMilliseconds / trimAreaDuration.inMilliseconds))
            .toInt();
        ...
        final preciseAreaDuration = Duration(
            milliseconds: (totalDuration.inMilliseconds * trimAreaLength) ~/ preciseTotalLength);
